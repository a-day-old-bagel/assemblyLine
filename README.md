Assembly Line is a small templated header-only C++ library. It is meant to be used in systems that deal with lots of data being streamed through many different operations, or "modules".
